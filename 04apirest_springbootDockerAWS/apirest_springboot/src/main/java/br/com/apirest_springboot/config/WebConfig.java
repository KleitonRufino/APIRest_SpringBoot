...
import br.com.apirest_springboot.serialization.converter.YamlJackson2HttpMessageConverter;
...
public class WebConfig implements WebMvcConfigurer {
	...
	public void addCorsMappings(CorsRegistry registry) {
		registry.addMapping("/**").allowedMethods("GET", "POST", "PUT", "DELETE", "PATCH", "OPTIONS", "TRACE",
				"CONNECT");
	}
